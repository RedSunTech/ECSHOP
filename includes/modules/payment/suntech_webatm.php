...
$suntech_payment = 'suntech_webatm';
...
class suntech_webatm
{
    ...
    {
        $this->suntech_webatm();
        $this->suntech_payment = 'suntech_webatm';
    }

    function suntech_webatm()
    {
    }
    ...
    function respond()
    {
        ...
        if ($store_type != '') {
            ...
            if (($_POST['errcode'] === "00") || ($_POST['errcode'] === "0")) {
                ...
                // order_action($order_info['order_sn'], $order_info['order_status'], $order_info['shipping_status'], $order_info['pay_status'], urldecode($_POST['errmsg']), $GLOBALS['_LANG']['buyer']);
                // setOrderFeedBack($order_info['user_id'], urldecode($_POST['errmsg']), $order_info['order_id']);
                return false;
            }
        }
    }
