...
$suntech_payment = 'suntech_unionpay';
...
class suntech_unionpay
{
    ...
    {
        $this->suntech_unionpay();
        $this->suntech_payment = 'suntech_unionpay';
    }

    function suntech_unionpay()
    {
    }
    ...
    function get_code($order, $payment)
    {
        ...
        $form .= '<input type="hidden" name="Card_Type" value="1">';//交易類別
